...
namespace ca.HenrySoftware.Rage
{
	...
	public static partial class Utility
	{
		...
		public static Vector2 ConstrainRect(Bounds screen, Bounds map)
		{
			return ConstrainRect(screen.min, screen.max, map.min, map.max);
		}
		public static Vector2 ConstrainRect(Vector2 minScreen, Vector2 maxScreen, Vector2 minMap, Vector2 maxMap)
		{
	...
	{
		public static Vector3Int Vector3Int(this Vector2Int p) => new Vector3Int(p.x, p.y, 0);
		public static Vector2Int Vector2Int(this Vector3Int p) => new Vector2Int(p.x, p.y);
